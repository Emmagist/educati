      ...
      <div class="col-lg-4 col-md-5 my-3">
        <div class="card px-4 py-5 text-center">
         ...
         <div class="input-group input-group--focus mb-3">
            ...
            <input type="text" class="form-control border-left-0 pl-0" placeholder="Name" name="">
          </div>
         <div class="input-group input-group--focus mb-3">
            <div class="input-group-prepend">
         ...
         <div class="input-group input-group--focus mb-3">
          ...
          <button type="submit" name="register_button" class="btn btn-block btn-primary">Register Now</button>
        </div>
      </div>
    </div> <!-- END row-->
  </div> <!-- END container--> 
