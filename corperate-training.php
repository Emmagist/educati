  ...
  <section class="padding-y-100">
    ...
    <div class="row align-items-center mb-5">
      <div class="col-lg-6">
        ...
        <p class="mb-2">
        Our training is designed to allow graduates and working class to develop vital skills and understanding required to excel in the workplace……
        Our corporate training is designed to allow graduates and working class to develop vital skills and understanding required to excel in the workplace. We deliver short and long-term courses which can be tailored to individual organization needs which also lead to recognized industry certifications.
        </p>
        <p class="mb-2">All our courses include theoretical and practical activities which is designed using real life scenarios which candidates can apply to their work environment.</p>
        <h6>Our commercial courses include:</h6>
...
<footer class="site-footer">
  ...
  <div class="footer-bottom bg-black-0_9 py-5 text-center">
    <div class="container">
      <p class="text-white-0_5 mb-0">&copy; 2018 Educati. All rights reserved. Created by <a href="../../external.html?link=http://echotheme.com/" target="_blunk">EchoTheme</a></p>
    </div>
...
<!-- Mirrored from echotheme.com/educati/page-about.html by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 18 Jan 2021 16:35:34 GMT -->
</html>