...
<html lang="en">
<head>
<title> <?php echo $_SESSION['status']['username'] ?> check out | acadasuite </title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8" />
    <meta name="keywords" content="online courses, eLearning, virtual classroom, school portal, School management software, school management solution, school website, students, teachers, english language, mathematics, science, social studies,  education in africa,  quality education for every Africa learner, <?php echo $_GET["category"] ?> " />
    ...
    <meta name="og:title" property="og:title" content="Online Courses, eLearning and School Management Software, <?php echo $_GET["category"] ?>">
    ...
    <!-- Custom Theme files -->
    <link href="<?php echo SITEURL2 ?>/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="<?php echo SITEURL2 ?>/icofont/icofont.min.css" rel="stylesheet">
    <link href="<?php echo SITEURL2 ?>/css/style.css" type="text/css" rel="stylesheet" media="all">
<!------ Include the above in your HEAD tag ---------->

    
    <!-- font-awesome icons -->
    <link href="<?php echo SITEURL2 ?>/css/font-awesome.min.css" rel="stylesheet">
    <link rel="shortcuticon icon" type="image/x-icon" href="<?php echo SITEURL2 ?>/images/favicon.ico">
